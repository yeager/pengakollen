...
class MainWindow(Adw.ApplicationWindow):
    def __init__(self, **kwargs):
        ...
        app_btn = Gtk.Button()
        app_btn.set_icon_name("se.danielnylander.pengakollen")
        app_btn.add_css_class("flat")
        app_btn.set_tooltip_text(_("Pengakollen"))
...
class App(Adw.Application):
    def __init__(self):
        ...
        about.connect('activate', lambda a,p: Adw.AboutDialog(application_name=_('Money Skills'),
